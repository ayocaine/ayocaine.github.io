const e="Guides/pages.mdx",t="docs",n="guides/pages",o=`
...
A snippet template is also included with this project if you are using vscode. Just type \`docs\` in any \`.md\` or \`.mdx\` file and you will see a suggestion for a template named \`docs\`. Most of the frontmatter properties are commented. Uncomment them by removing \`#\`. For date and time we use [standard date-time string format](https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Global_Objects/Date#date_time_string_format).`,a={title:"Pages",author:"HYP3R00T",draft:!1,tags:[],hide_breadcrumbs:!1,hide_toc:!1,hide_sidenav:!1,max_width:!1},s={type:"content",filePath:"/home/runner/work/ayocaine.github.io/ayocaine.github.io/src/content/docs/Guides/pages.mdx",rawData:void 0};export{s as _internal,o as body,t as collection,a as data,e as id,n as slug};
